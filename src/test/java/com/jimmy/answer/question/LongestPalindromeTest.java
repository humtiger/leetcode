...
public class LongestPalindromeTest {
    ...
    @Test
    public void givenStringWhenTooLoneThenFast() {
        Long begin = System.currentTimeMillis();
        ...
        Assert.assertTrue(end - begin < 100);
        Assert.assertNotNull(babad);
        Assert.assertEquals("", babad);
    }
}